...
public interface FunctionCraftListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link FunctionCraftParser#functionCraft}.
	 * @param ctx the parse tree
	 */
	void enterFunctionCraft(FunctionCraftParser.FunctionCraftContext ctx);
	/**
	 * Exit a parse tree produced by {@link FunctionCraftParser#functionCraft}.
	 * @param ctx the parse tree
	 */
	void exitFunctionCraft(FunctionCraftParser.FunctionCraftContext ctx);
	/**
