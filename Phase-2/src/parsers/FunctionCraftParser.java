...
public class FunctionCraftParser extends Parser {
	...
	public final PatternMatchingContext patternMatching() throws RecognitionException {
		...
		try {
			...
			//        System.out.println("This is patternDecl line number: " + ((PatternMatchingContext)_localctx).pat.getLine());
			        _localctx.patternRet.setLine(((PatternMatchingContext)_localctx).pat.getLine());
