...
public interface FunctionCraftVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link FunctionCraftParser#rangeOp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRangeOp(FunctionCraftParser.RangeOpContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link FunctionCraftParser#if_statement_in_loop}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIf_statement_in_loop(FunctionCraftParser.If_statement_in_loopContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunctionCraftParser#else_if_statement_in_loop}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElse_if_statement_in_loop(FunctionCraftParser.Else_if_statement_in_loopContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunctionCraftParser#else_statement_in_loop}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElse_statement_in_loop(FunctionCraftParser.Else_statement_in_loopContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunctionCraftParser#conditional_expression_in_loop}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConditional_expression_in_loop(FunctionCraftParser.Conditional_expression_in_loopContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link FunctionCraftParser#function_call_suffix}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunction_call_suffix(FunctionCraftParser.Function_call_suffixContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link FunctionCraftParser#factor_suffix}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFactor_suffix(FunctionCraftParser.Factor_suffixContext ctx);
	/**
	 * Visit a parse tree produced by {@link FunctionCraftParser#term_op}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTerm_op(FunctionCraftParser.Term_opContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link FunctionCraftParser#arithmetic_sum}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArithmetic_sum(FunctionCraftParser.Arithmetic_sumContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link FunctionCraftParser#statement_in_loop}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStatement_in_loop(FunctionCraftParser.Statement_in_loopContext ctx);
	/**
